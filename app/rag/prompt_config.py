...
class PromptConfig:
    ...
    CUSTOM_TEMPLATE_STR = textwrap.dedent(
        ...
        Правила:
        1. Если в контексте есть хотя бы упоминание темы — подтверди это и кратко процитируй.
        2. Если темы нет — скажи: "В документах нет информации по этому вопросу".
        3. Не требуй полного ответа, достаточно факта наличия/отсутствия.
        4. Пиши сразу с сути, без вступлений и служебных формулировок.
